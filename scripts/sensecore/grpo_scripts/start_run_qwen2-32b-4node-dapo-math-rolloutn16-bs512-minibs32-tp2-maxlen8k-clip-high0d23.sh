...
if [ "$RANK" = "0" ]; then
    ...
    ./examples_sensecore/grpo_trainer/run_qwen2-32b-4node-dapo-math-rolloutn16-bs512-minibs32-tp4-maxlen8k-clip-higher0d23.sh 2>&1 | tee logs_sensecore/run_qwen2-32b-4node-dapo-math-rolloutn16-bs512-minibs32-tp4-maxlen8k-clip-higher0d23.log
else
    # 工作节点连接到Ray主节点
