...
export project_name=verl_kk_logic_grpo_vllm082
...
nnode=1
export experiment_name=Qwen2.5-7B-1M-Instruct_kk_grpo_vllm_0_8_2_${nnode}node_realbs${real_train_batch_size}_lr${lr}_tp${vllm_tp}_maxlen${max_response_length}
export TENSORBOARD_DIR=/nvfile-heatstorage/teleai-infra/wlw/${project_name}/${experiment_name}/tensorboard_log
...
python3 -u -m verl.trainer.main_ppo \
    ...
    trainer.default_local_dir=/nvfile-heatstorage/teleai-infra/wlw/${project_name}/${experiment_name} \
