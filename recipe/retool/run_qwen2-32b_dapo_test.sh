...
echo $HDFS_ROOT
dapo_math_17k=/nvfile-heatstorage/chatrl/users/hxh/data/rule_based_rl/DAPO-Math-17k/data
aime_2024=/nvfile-heatstorage/chatrl/users/hxh/data/rule_based_rl/DAPO-AIME-2024/data
...
python3 -m verl.trainer.main_ppo \
    ...
    data.custom_cls.path=$HDFS_ROOT/recipe/retool/retool.py \
    data.custom_cls.name=CustomRLHFDataset \
    custom_reward_function.path=$HDFS_ROOT/recipe/retool/retool.py \
