...
def _default_compute_score(data_source, solution_str, ground_truth, extra_info=None):
    if data_source == 'openai/gsm8k':
        ...
        # res = math_verify.compute_score(solution_str, ground_truth)
            ...
            'DeepScaleR_no_system', 'dapo_aime2025_s32_no_system', 'dapo_aime2024_s32_no_system', 
        ...
        res = math_dapo.compute_score(solution_str, ground_truth)
            ...
            'math_verify-train-math-numinamath1.5_aops_forum_total'
    ] :
        ...
        # judge model port/model配置在下面文件开头/afs/chatrl/users/hwq/code/verl-req-sched/verl/utils/reward_score/remote_reward/__init__.py
