...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def __init__(self,
                 ...
                 processing_class: Union[PreTrainedTokenizer,
                                         ProcessorMixin] = None,
                 **kwargs):
        ...
        if del_local_after_load:
            try:
                ...
                os.remove(local_extra_state_path) if is_non_local(
                    local_extra_state_path) else None
    ...
    def save_checkpoint(self,
        ...
        with warnings.catch_warnings():
            ...
            with FSDP.state_dict_type(self.model,
                ...
                torch.save(optimizer_state_dict,
                           optim_path)  # TODO: address optimizer is None
        ...
        if self.rank == 0:
            ...
            self.model._fsdp_wrapped_module.config.save_pretrained(
                hf_local_path)
