...
_MODELS_SUPPORT_RMPAD = {
    'llama', 'mistral', 'gemma', 'qwen2', 'qwen2_vl', 'qwen2_5_vl'
}
...
def check_model_support_rmpad(model_type: str):
    ...
    if model_type in ("qwen2_vl",
                      "qwen2_5_vl"):  # patch remove padding for qwen2vl mrope
...
_MODELS = {
    ...
    "Qwen2ForCausalLM": ("qwen2", ("ParallelQwen2ForCausalLMRmPadPP",
                                   "ParallelQwen2ForValueRmPadPP",
                                   "ParallelQwen2ForCausalLMRmPad")),
    "MistralForCausalLM": ("mistral", ("ParallelMistralForCausalLMRmPadPP",
