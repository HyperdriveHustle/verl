...
python3 -u -m  recipe.dapo.main_dapo \
    ...
    trainer.total_epochs=${total_epochs} 2>&1 | tee /afs/chatrl/users/kzl/code/verl/logs_sensecore/$experiment_name.log