...
export train_data_type=${train_data_type:-dapomath}
...
export experiment_name=Qwen25-32B-Base_grpo_${nnode}node_reward_rollout${grpo_rollout_n}_bs${train_prompt_batch_size}_minibatch${ppo_mini_batch_size}_lr${lr}_tp${vllm_tp}_maxlen${max_response_length}_clip_high${clip_ratio_high}
