...
aime2024_test_path=/afs/chatrl/users/hxh/data/rule_based_rl/AIME-2024/dapo_aime2024_sample8.parquet
...
# model config
export model_path=${model_path:-/afs/chatrl/public/models/TeleBase2-35B-32K-GPU-3_5T-anneal-20250103-hf-llamafied_bf16}
...
export project_name=verl_telechat2_grpo_dapo_math
...
export experiment_name=TeleBase2_grpo_${nnode}node_reward_rollout${grpo_rollout_n}_bs${train_prompt_batch_size}_minibatch${ppo_mini_batch_size}_lr${lr}_tp${vllm_tp}_maxlen${max_response_length}_clip_high${clip_ratio_high}
