...
export model_path=${model_path:-/afs/chatrl/public/models/Qwen2.5-7B-Instruct-1M}
# project config
export project_name=${project_name:-verl_dapo_math_dapo_req_sched}
# train params
...
export experiment_name=Qwen2.5-7B-1M-Instruct_dapo_math_grpo_reqsched-${req_algo}-${agg}_${nnode}node_rollout${grpo_rollout_n}_bs${train_prompt_batch_size}_lr${lr}_tp${vllm_tp}_maxlen${max_response_length}
